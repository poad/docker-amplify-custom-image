...
RUN curl -fsSLo setup_16.x https://deb.nodesource.com/setup_16.x \
 && curl -fsSLo setup_14.x https://deb.nodesource.com/setup_14.x \
...
COPY --from=downloader /tmp/setup_14.x /tmp/setup_14.x
COPY --from=downloader /tmp/setup_16.x /tmp/setup_16.x
...
RUN apt-get update -qq \
 ...
 && apt-get clean \
 && rm -rf /var/lib/apt/lists/* /var/log/apt/* /var/log/alternatives.log /var/log/dpkg.log /var/log/faillog /var/log/lastlog /tmp/setup_14.x /tmp/setup_16.x
